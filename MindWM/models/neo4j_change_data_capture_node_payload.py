...
class Neo4jChangeDataCaptureNodePayload(BaseModel):
    ...
    id: StrictStr
    type: StrictStr
    __properties: ClassVar[List[str]] = ["after", "before", "id", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "after": Neo4jChangeDataCaptureNodePayloadAfter.from_dict(obj["after"]) if obj.get("after") is not None else None,
